...
CONF_OUTDOOR_TEMP_AUXILIARY_HEATING_THRESHOLD = "outdoor_temp_auxiliary_heating_threshold"
CONF_HUMIDITY_THRESHOLD = "humidity_threshold"
CONF_CO2_THRESHOLD = "co2_threshold"
CONF_CO2_HIGH_DELAY_MINUTES = "co2_high_delay_minutes"
CONF_FAN_LEVEL_HIGH_CO2 = "fan_level_high_co2"
...
DEFAULT_FAN_LEVEL_HIGH_CO2 = 3
DEFAULT_CO2_THRESHOLD = 1000      # ppm — caution level
DEFAULT_CO2_HIGH_DELAY_MINUTES = 5

DEFAULT_OUTDOOR_TEMP_HEATING_THRESHOLD = 16.0
DEFAULT_OUTDOOR_TEMP_AUXILIARY_HEATING_THRESHOLD = 10.0
